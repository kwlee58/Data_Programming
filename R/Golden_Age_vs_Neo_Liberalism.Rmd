...
# par(mfrow = c(1, 2))
x1 <- barplot(Golden_Age, horiz = TRUE, col = "tan", axes = FALSE, names.arg = "", xlim = c(0, 140), space = 0.5, las = 1, axisnames = TRUE)
title_1 <- "Golden Age\n1947 ~ 1979"
# title(main = title_1)
...
x2 <- barplot(Neo_Liberal, horiz = TRUE, col = "cadetblue", axes = FALSE, names.arg = Fifth, xlim = c(0, 80), space = 0.5, las = 1, axisnames = TRUE)
title_2 <- "Neo Liberalism\n1980 ~ 2009"
title(main = title_2, cex.main = 2.0)
abline(v = 0, lwd = 5)
text(Neo_Liberal + c(rep(5, 4), 10), x2, labels = paste(Neo_Liberal, "%", sep = ""), cex = 1)
