...
```{r}
Gini_b_tax <- read.table(file="../data/Gini_before_tax.txt", header = FALSE, sep = "\t")
Gini_a_tax <- read.table(file="../data/Gini_after_tax.txt", header = FALSE, sep = "\t")
str(Gini_b_tax)
str(Gini_a_tax)
```
...
```{r}
(Gini_b_a<-data.frame(Country = Gini_b_tax$V1, Before = Gini_b_tax$V8, After = Gini_a_tax$V8))
```
...
```{r}
save(file = "Gini_OECD1801.RData", list = ls())
