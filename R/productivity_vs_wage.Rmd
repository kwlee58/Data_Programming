...
plot(Net_productivity ~ Year, data = prod_wage, type = "l", col = "blue", xlab = x.lab, ylab = y.lab, main = main.title, lwd = 5, ylim = c(-50, 300), las = 1)
lines(Hourly_compensation ~ Year, data = prod_wage, col = "cyan", lwd = 5)
...
plot(Net_productivity ~ Year, data = prod_wage_2, type = "l", col = "blue", xlab = x.lab, ylab = y.lab.2, main = main.title.2, lwd = 5, xlim = c(1973, 2018), ylim = c(-5, 80), las = 1)
lines(Real_average_hourly_compensation ~ Year, data = prod_wage_2, col = "deepskyblue", lwd = 5)
lines(Real_median_hourly_compensation ~ Year, data = prod_wage_2, col = "cyan", lwd = 5)
