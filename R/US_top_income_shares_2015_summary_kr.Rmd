...
# f6
f7 <- f6 + 
  annotate("text", x = c(1935, 1965, 2015), y = c(48.5, 32, 46.5), label = times_label, colour = "red", family = "HCR Dotum LVT", size = 8)
```
...
# g12
g13 <- g12 + 
  annotate("text", x = c(1935, 1960, 2015), y = c(22, 8, 18), label = times_label, colour = "red", family = "HCR Dotum LVT", size = 8)
...
# h12
h13 <- h12 + 
  annotate("text", x = c(1935, 1960, 2015), y = c(9, 2, 8), label = times_label, colour = "red", family = "HCR Dotum LVT", size = 8)
...
# j12
j13 <- j12 + 
  annotate("text", x = c(1935, 1960, 2015), y = c(5.6, 2.8, 3.0), label = times_label, colour = "red", family = "HCR Dotum LVT", size = 8)
