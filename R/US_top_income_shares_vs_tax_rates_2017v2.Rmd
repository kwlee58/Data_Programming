...
box()
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
y2_at <- c(0, z(c(Rate_99, Rate_1), c(100, 200, 300)), 1)
labels2_at <- format(c(min(c(Rate_99, Rate_1)), c(100, 200, 300), max(c(Rate_99, Rate_1))),
                    digits = 2, nsmall = 1)
...
box()
axis(side = 1, at = seq(1910, 2020, by = 10), labels = seq(1910, 2020, by = 10))
y3_at <- c(0, z(c(Rate_99_K, Rate_1_K), seq(100, 500, by = 100)), 1)
labels3_at <- format(c(min(c(Rate_99_K, Rate_1_K)), seq(100, 500, by = 100), max(c(Rate_99_K, Rate_1_K))),
                    digits = 2, nsmall = 1)
