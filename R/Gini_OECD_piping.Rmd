...
ggplot(data = Gini_b_a_order_melt, 
  ...
  theme_bw() +
  theme_kr +
  scale_fill_brewer(name = "", labels = c("세전", "세후"), type = "qual", palette = "Paired") +
  labs(title = "OECD 지니계수", 
#       subtitle = "세전 세후 비교", 
       x = "개선도 순 나라 이름",
       y = "지니계수") +
  theme(plot.title = element_text(size = 15, hjust = 0.5),
        plot.subtitle = element_text(family = "HCR Dotum LVT", size = 10, hjust = 0.5)) +
coord_flip()
ggsave(filename = "../pics/OECD_Gini_ggplot.png")
```
